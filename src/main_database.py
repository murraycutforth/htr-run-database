...
def main():
    ...
    database_creators = [
        ...
        CreateDatabaseBatchV18(),
        CreateDatabaseBatchV19(),
        CreateDatabaseBatchV20(),
        CreateDatabaseBatchV21(),
        CreateDatabaseBatchV22(),
        CreateDatabaseBatchV23(),
        CreateDatabaseBatchV24(),
        CreateDatabaseBatchV25(),
        CreateDatabaseBatchV26(),
        CreateDatabaseBatchV27(),
        CreateDatabaseBatchV28(),
        CreateDatabaseBatchV29(),
        CreateDatabaseBatchV30(),
        CreateDatabaseBatchV31(),
    ]
